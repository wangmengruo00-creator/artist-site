(() => {
  const translations = new Map(Object.entries({
    ...
    "Four current projects in which material, bodily, and computational forms of reading are tested through distinct systems.": "四个当前项目，分别在不同系统中测试材料性、身体性与计算性的阅读方式。",
